...
const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/blitzcraft",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/blitzcraft",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <p className="text-4xl lg:text-6xl leading-[3rem] text-center text-zinc-900 font-bold">
          ...
          <Image
            ...
            className="-mt-1.5 h-8 w-8 lg:h-14 lg:w-14 ml-3 lg:ml-4 inline"
            height={512}
            width={512}
            alt=""
          />
        ...
        <div className="mt-12 max-w-2xl text-xl sm:text-2xl mx-auto text-center font-semibold text-zinc-500">
          Building {process.env.NEXT_PUBLIC_APP_NAME} has been an incredibly fun
          effort across many people at {process.env.NEXT_PUBLIC_APP_NAME} and
          our frens at other companies. We&apos;re always looking to make{" "}
          {process.env.NEXT_PUBLIC_APP_NAME} better, so please let us know how
          we can improve.
        </div>
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          &copy; 2023 {process.env.NEXT_PUBLIC_APP_NAME}. All rights reserved.
        </p>
      </div>
    </footer>
  );
